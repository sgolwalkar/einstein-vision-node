...
import './heroku-logo.css';

class HerokuLogo extends Component {
        ...
        <symbol id="heroku-text">
          ...
          <defs>
              <linearGradient x1="0%" y1="100%" x2="100%" y2="0%" id="heroku-gradient">
                <stop stopColor="#5B38AA" stopOpacity="100" offset="0%"></stop>
                <stop stopColor="#45049A" stopOpacity="100" offset="100%"></stop>
              </linearGradient>
          </defs>

          <g className="logo-glyph" id="heroku-logo" x="0" y="0" fillRule="evenodd">
            <rect x="1" y="1" width="70" height="78" rx="5"/>
            <use xlinkHref="#heroku-border"/>
            <use xlinkHref="#heroku-h" />
          </g>
      </svg>);
  }
